...
import static com.telega.test.hand.QuizHandler.QUIZ_START;
...
public class RegistrationHandler implements Handler {
    ...
    private List<PartialBotApiMethod<? extends Serializable>> checkName(User user, String message) {
        ...
        List<InlineKeyboardButton> inlineKeyboardButtonsRowOne = List.of(createInlineKeyboardButton("Accept", NAME_ACCEPT));
